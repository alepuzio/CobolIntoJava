...
import net.alepuzio.cobolintojava.enumeration.EnumSourceCode;
import net.alepuzio.cobolintojava.generateFile.input.ConfigurationTemplateFactoryInputForHost;
import net.alepuzio.cobolintojava.generateFile.output.ConfigurationTemplateFactoryInputFromHost;
import net.alepuzio.cobolintojava.util.UtilFormat;
import net.alepuzio.cobolintojava.util.UtilIO;
...
public abstract class TemplateFactoryBeanInputOuput {
	...
	private  static final String EXTENSION = ".java";
	  ...
	  * net.alepuzio.cobolintojava.enumeration.EnumSourceCode
